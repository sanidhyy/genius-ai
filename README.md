...
### 10. AI Settings Cookie Secrets

Generate two separate secrets with `openssl rand -hex 32` and set them as `AI_SETTINGS_COOKIE_NAME` and `VERIFICATION_SECRET`. These encrypt and name the httpOnly cookie that stores each user's OpenAI and Replicate credentials from **Settings**.
...
11. Open terminal in root directory. Run `npm install --legacy-peer-deps` or `pnpm install --legacy-peer-deps`.

12. Now app is fully configured 👍 and you can start using this app using either one of `npm run dev` or `pnpm dev`.
...
- **GitHub Discussions** — [Open a Q&A discussion](https://github.com/sanidhyy/genius-ai/discussions/new?category=q-a) for setup and troubleshooting help.
...
- [lucide-react](https://www.npmjs.com/package/lucide-react): ^1.42.0
...
[![Tweet about this project](https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Fx.com%2F_sanidhyy)](https://x.com/intent/tweet?text=Check+out+this+amazing+app:&url=https%3A%2F%2Fgithub.com%2Fsanidhyy%2Fgenius-ai "Tweet about this project")

...
# encryption secret (generated by `openssl rand -hex 32`)
...
### 10. Encryption Secret

Generate a 32-byte hex secret and set it as `ENCRYPTION_SECRET`. This encrypts user OpenAI and Replicate keys stored in HTTP-only cookies (they expire automatically after 30 days).
